...
{
    // Класс Модель для вывода таблицы Persons      (Персоны)
    internal class ShowModelPersons
    {
        ...
        public ShowModelPersons() : this(default) { }

        // конструктор инициализирующий
        public ShowModelPersons(SqlDataReader dataReader)
        {
            // установка значений
        ...
        {
            //                  Id 2             LastName 20        FirstName 20      Patronymic 20           
            WriteColorXY("     ╔════╦══════════════════════╦══════════════════════╦══════════════════════╗\n",
