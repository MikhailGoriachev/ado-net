...
{
    // Класс Модель для вывода таблицы Brands		(Модели_автомобилей)
    internal class ShowModelBrands
    {
        ...
        public ShowModelBrands() : this(default) { }

        // конструктор инициализирующий
        public ShowModelBrands(SqlDataReader dataReader)
        {
            // установка значений
        ...
        public void ShowElem()
        {
            ...
            WriteColorXY($"{_dataReader.GetString(1),-20}", 12, textColor: ConsoleColor.DarkGreen);
            Console.WriteLine();
        }
