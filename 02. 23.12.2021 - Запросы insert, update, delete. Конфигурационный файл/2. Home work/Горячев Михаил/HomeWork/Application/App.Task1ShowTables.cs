...
namespace HomeWork.Application
{
    ...
    {
        #region 1. Просмотр содержимого таблиц задания 1

        /*
         * 1. Просмотр содержимого таблиц задания 1
         */

        // 1. Просмотр содержимого таблиц задания 1
        public void Task1ShowTables()
        {
            #region Меню
            ...
            void Point1()
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionStringTask1))
                {
                    // подключение к серверу
                    connection.Open();

                    // запрос для выбора всех записей таблицы Transaction
                    SqlCommand cmd = new SqlCommand(@"ShowTransactions");
            ...
            void Point2()
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionStringTask1))
                {
                    ...
                    // запрос для выбора всех записей таблицы Immovables
                    SqlCommand cmd = new SqlCommand("ShowImmovables");
            ...
            void Point3()
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionStringTask1))
                {
                    ...
                    // создание комманды
                    SqlCommand command = new SqlCommand("ShowRealtors");
            ...
            void Point4()
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionStringTask1))
                {
                    ...
                    // создание команды
                    SqlCommand command = new SqlCommand("ShowOwners");
            ...
            void Point5()
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionStringTask1))
                {
                    ...
                    // создание команды
                    SqlCommand command = new SqlCommand("ShowStreets");
            ...
            void Point6()
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionStringTask1))
                {
                    ...
                    // создание команды
                    SqlCommand command = new SqlCommand("ShowPersons");
